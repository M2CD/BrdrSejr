...
<?php include 'includes/header_inc.php'; ?>
    ...
    <section class="main">
		...
		<section class="webshopbox">
			...
			<p>Vi stræber at blive en af nettets absolut største online forhandlere af alt inden for MC beklædning, udstyr og reservedele. Når du handler her hos os, er du dermed altid sikret et stort og velassorteret udvalg både med hensyn til mærker og forskellige modeller. Vi udvælger nøje alle produkter til vores webshop, så du som kunde er sikret en høj grad af kvalitet og sikkerhed. Alle vore valg baseres på en stor passion og ekspertise inden for MC.</p>
			<p>Når det drejer sig om MC beklædning her hos Brdr. Sejr, har du altid flere forskellige valgmuligheder. Vi forhandler både MC læderbeklædning og MC tekstil beklædning fra anerkendte mærker, hvor der er stor fokus på god pasform, kvalitet og sikkerhed i deres udvalget af de forskellige former for MC beklædning. Skal du for eksempel bruge en ny MC jakke eller et par bukser med en god pasform, finder du dem helt sikkert i udvalget her hos os.</p>
			<p>Her hos Brdr. Sejr kan vi også præsentere dig for et varieret udvalg af MC udstyr. Står du og mangler praktisk og funktionelt udstyr til din MC, er du kommet til det rette sted. Vores sortiment byder på alt fra låse til bluetooth head-sets og meget mere.</p>
			<p>Udover det store udvalg af MC beklædning og udstyr, har vi også et stort udvalg af MC reservedele. Står du og mangler nogle dele til din MC, kan vi helt sikkert hjælpe dig. Vores udvalg er stort, og vi garanterer den bedste service</p>
			<p><strong>Se dig omkring her på webshoppen, og kan du ikke finde det du søger, kan du altid kontakte os, og så finder vi ud af det sammen. God fornøjelse!</strong></p>
		</section>
